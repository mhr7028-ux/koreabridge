    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#0a0b10' }}>
      <aside style={{ width: '250px', borderRight: '1px solid #1f2937', padding: '20px' }}>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          ...
          <Link href="/admin/missions" style={{ color: '#e5e7eb', textDecoration: 'none' }}>📍 Busan Adventure (Missions)</Link>
          <Link href="/admin/bookings" style={{ color: '#e5e7eb', textDecoration: 'none' }}>🚲 Manage Rentals & Tours</Link>
